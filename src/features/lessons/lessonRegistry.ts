...
const lessonLoadersByNumber: Record<number, LessonLoader> = {
  ...
  63: async () => (await import("./aula-63-nova/config")).aula63NovaLesson,
  64: async () => (await import("./aula-64-nova/config")).aula64NovaLesson,
  65: async () => (await import("./aula-65-nova/config")).aula65NovaLesson,
  66: async () => (await import("./aula-66-nova/config")).aula66NovaLesson,
  67: async () => (await import("./aula-67-nova/config")).aula67NovaLesson,
  68: async () => (await import("./aula-68-nova/config")).aula68NovaLesson,
  69: async () => (await import("./aula-69-nova/config")).aula69NovaLesson,
  70: async () => (await import("./aula-70-nova/config")).aula70NovaLesson,
  71: async () => (await import("./aula-71-nova/config")).aula71NovaLesson,
  72: async () => (await import("./aula-72-nova/config")).aula72NovaLesson,
  73: async () => (await import("./aula-73-nova/config")).aula73NovaLesson,
  74: async () => (await import("./aula-74-nova/config")).aula74NovaLesson,
};
